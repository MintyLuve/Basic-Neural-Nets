...
X_train, X_validate, y_train, y_validate = train_test_split(X_train, y_train, test_size = 10, random_state = 2, stratify = y_train)
...
neural_net_model = MLPClassifier( hidden_layer_sizes=(20),random_state=None,tol=0.005)
...
print(f"Overall Validation Accuracy: {overall_training_accuracy:3.1f}%")
...
# Misidenitfies
print("This program often misidentifies class 4/ letter E for class 2/ letter C, but gets everything else correct")